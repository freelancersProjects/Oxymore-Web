...
interface KanbanBoard extends RowDataPacket {
...
interface KanbanTicket extends RowDataPacket {
...
interface KanbanTag extends RowDataPacket {
...
interface CreateKanbanBoardRequest {
  name: string;
  description?: string;
  color?: string;
}

interface UpdateKanbanBoardRequest {
  name?: string;
  description?: string;
  color?: string;
}

interface CreateKanbanTicketRequest {
  id_kanban_board: string;
  title: string;
  description?: string;
  status?: 'todo' | 'in_progress' | 'done';
...
interface UpdateKanbanTicketRequest {
  title?: string;
  description?: string;
  status?: 'todo' | 'in_progress' | 'done';
  priority?: 'low' | 'medium' | 'high' | 'urgent';
...
interface CreateKanbanTagRequest {
  name: string;
  color?: string;
  description?: string;
}
...
interface KanbanBoardStats extends RowDataPacket, KanbanStats {
  id_kanban_board: string;
  name: string;
  color: string;
}
