import { ChannelBot, ChannelBotData } from "../../interfaces/messaging/messagingInterfaces";
...
export const createChannelBot = async (data: { name: string; user_id: string }): Promise<ChannelBotData> => {
  ...
  return { id_channel, name: data.name, user_id: data.user_id, created_at };
};
