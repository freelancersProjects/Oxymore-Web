...
// Méthodes de fallback avec les données de test
export const getAllNotificationsFallback = (): Notification[] => {
  return notifications;
};

export const getNotificationsByUserIdFallback = (userId: string): NotificationWithReadStatus[] => {
...
export const getUnreadNotificationsCountFallback = (userId: string): number => {
