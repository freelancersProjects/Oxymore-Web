import { GroupMember, GroupMemberInput } from "../models/groupMemberModel";
...
export const createGroupMember = async (data: GroupMemberInput): Promise<GroupMember> => {
...
export const inviteFriendToGroup = async (groupId: string, userId: string, role: 'member' | 'admin' = 'member'): Promise<GroupMember> => {
