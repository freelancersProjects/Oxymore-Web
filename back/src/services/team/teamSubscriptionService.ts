import { TeamSubscription, TeamSubscriptionData } from "../../interfaces/team/teamInterfaces";
...
export const createTeamSubscription = async (data: any): Promise<TeamSubscriptionData> => {
