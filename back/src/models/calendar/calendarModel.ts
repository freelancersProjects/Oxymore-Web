 ...
 *         type:
 *           type: string
 *           enum: [meeting, training, tournament, league, other]
 *         attendees:
 *           type: array
 *           items:
 *             type: string
...
import { CalendarAppointment, CreateAppointmentData, UpdateAppointmentData, CalendarStats } from '../../interfaces/calendar/calendarInterfaces';
