...
const CreateTournament = () => {
  return (
    <div className="create-tournament-page" style={{ position: 'relative', overflow: 'hidden' }}>
      <OXMGlowOrb top="-10%" left="-15%" size="700px" color="rgba(80,12,173,0.18)" />
      <OXMGlowOrb bottom="-10%" right="-10%" size="900px" color="rgba(21,147,206,0.13)" />
      ...
      <header className="create-tournament-header">
        ...
        <p className="outfit">Design your own bracket, invite teams, and make your event legendary.</p>
      </header>
      <div className="bracket-svg-container">
        <svg viewBox="0 0 1200 300" className="bracket-svg">
          <polyline points="50,50 300,50 300,150 600,150 600,250 1150,250" fill="none" stroke="#1593ce" strokeWidth="8" strokeLinejoin="round" strokeLinecap="round" opacity="0.7" />
      ...
      <div className="tournament-glass">
        ...
        <p className="outfit">Visualize your bracket, add teams, and customize your event. Stay tuned!</p>
      </div>
    </div>
  );
};
