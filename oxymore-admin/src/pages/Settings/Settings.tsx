      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="card-base p-6">
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-6">Theme Preferences</h2>
          ...
          <div className="card-base p-6">
            <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-6">Notification Settings</h2>
          ...
          <div className="card-base p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-2 rounded-lg hover:bg-[var(--overlay-hover)] transition-colors">
                <span className="text-[var(--text-primary)]">Toggle Theme</span>
              ...
              <div className="flex items-center justify-between p-2 rounded-lg hover:bg-[var(--overlay-hover)] transition-colors">
                <span className="text-[var(--text-primary)]">Toggle Sidebar</span>
                <div className="flex items-center gap-1">
                  <kbd className="px-2 py-1 bg-[var(--overlay-hover)] border border-[var(--border-color)] rounded-lg text-xs font-medium text-[var(--text-primary)]">⌘</kbd>
                  <span className="text-[var(--text-secondary)]">+</span>
              ...
              <div className="flex items-center justify-between p-2 rounded-lg hover:bg-[var(--overlay-hover)] transition-colors">
                <span className="text-[var(--text-primary)]">Quick Search</span>
                <div className="flex items-center gap-1">
                  <kbd className="px-2 py-1 bg-[var(--overlay-hover)] border border-[var(--border-color)] rounded-lg text-xs font-medium text-[var(--text-primary)]">⌘</kbd>
                  <span className="text-[var(--text-secondary)]">+</span>
              ...
              <div className="flex items-center justify-between p-2 rounded-lg hover:bg-[var(--overlay-hover)] transition-colors">
                <span className="text-[var(--text-primary)]">Show Shortcuts</span>
                <div className="flex items-center gap-1">
                  <kbd className="px-2 py-1 bg-[var(--overlay-hover)] border border-[var(--border-color)] rounded-lg text-xs font-medium text-[var(--text-primary)]">⌘</kbd>
                  <span className="text-[var(--text-secondary)]">+</span>
                  <kbd className="px-2 py-1 bg-[var(--overlay-hover)] border border-[var(--border-color)] rounded-lg text-xs font-medium text-[var(--text-primary)]">/</kbd>
