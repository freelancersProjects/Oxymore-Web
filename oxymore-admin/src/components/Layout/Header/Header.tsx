          ...
          <div className="relative">
            ...
            >
              ...
              <div className="pr-2">
                ...
                <p className="text-[var(--text-secondary)] text-xs">Super Admin</p>
              </div>
              ...
              {showProfile && (
                ...
                >
                  <div className="px-4 py-3 border-b border-[var(--border-color)]">
                    <p className="text-sm text-[var(--text-primary)] font-medium">Admin</p>
                    <p className="text-xs text-[var(--text-secondary)]">admin@oxymore.gg</p>
                  </div>
                  <Link
                    to="/settings"
